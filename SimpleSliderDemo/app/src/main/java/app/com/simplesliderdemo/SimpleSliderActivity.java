...
//            alfaValue = i ; //assign value
    ...
    private class ProviderSearchPareJSONdataAsyntask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            jsonResponse = serviceHandler.makeServiceCall("http://webservice.mycuratio.com/webservice/code/index.php?/ProviderNew/getProviderByPartialNameZipDistance/-1/60601/5", ServiceHandler.GET);
