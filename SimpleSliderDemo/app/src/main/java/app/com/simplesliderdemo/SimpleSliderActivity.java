...
public class SimpleSliderActivity extends FragmentActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        BitmapDescriptor IconMarkerplot = BitmapDescriptorFactory.fromResource(R.drawable.ic_cast_light);
        //map
...
//                                .title(String.valueOf(latLongHashMap.get("name" + loop))+" ")
//                                .snippet(" "+providerAddress)
                        .icon(IconMarkerplot));
            }

            map.animateCamera(CameraUpdateFactory.newLatLngZoom(
                    new LatLng(providerLatitude, providerLongitude), 12));
        }
        catch (Exception e)
        {
